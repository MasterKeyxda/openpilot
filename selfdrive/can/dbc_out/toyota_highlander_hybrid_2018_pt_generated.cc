...
const DBC toyota_highlander_hybrid_2018_pt_generated = {
  .name = "toyota_highlander_hybrid_2018_pt_generated",
...
dbc_init(toyota_highlander_hybrid_2018_pt_generated)